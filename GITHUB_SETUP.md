...
git clone https://github.com/CreatzionTraining/Site.git

just drag and drop the Site folder from Desktop into Antgravity — or click File → Open Folder and select it from Desktop.
